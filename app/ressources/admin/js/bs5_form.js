            ...
            case 'x-editable-boolean':
                $el.editable({
                    ...
                    display: function(value, response) {
                       ...
                       if(value == '1') {
                           $(this).html('<span class="bi bi-check-circle fa fa-check-circle glyphicon glyphicon-ok-circle icon-ok-circle"></span>');
                       } else {
                           $(this).html('<span class="bi bi-minus-circle fa fa-minus-circle glyphicon glyphicon-minus-sign icon-minus-sign"></span>');
                       }
                    },
