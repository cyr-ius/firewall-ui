...
js_custom = Bundle("../fwui/ressources/js/custom.js", filters="rjsmin", output="custom.js")
css_custom = Bundle("../fwui/ressources/css/custom.css", filters="cssmin", output="custom.css")
